...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div>
            <a href="index.html" class="navbar-brand m-1 p-1"> <img src="img/logo.png" width="30" height="24">DELL </a>
        </div>
    ...
    <section>
        ...
        <div class="container-fluid bg-secondary bg-gradient  " style="height: 715px;">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6 ">
                    <form  action="login.php" method="post" class="container bg-light bg-gradient  m-4 shadow-lg w-75 rounded-3">
                        ...
                        <br>
                        <div class="d-block">
                            <a class="ms-4 text-center" href="register.php">Don't have an account. Register ?</a>
                    ...
                    if ($_SERVER["REQUEST_METHOD"] == "POST") {
                        ...
                        if (!($conn)) {
                            ...
                            $sql = "SELECT * FROM `user` WHERE `email`= '$email' AND `pass`='$passd'";
